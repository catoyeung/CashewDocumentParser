...
namespace CashewDocumentParser.API.Helpers
{
    ...
    public class EmailSender : IEmailSender
    {
        ...
        private SmtpConfiguration _emailConfiguration { get; set; }
        public EmailSender(SmtpConfiguration emailConfiguration)
        {
        ...
        public bool SendRegisterVerificationEmail(string username, string toEmail, string verificationLink)
        {
            ...
            {
                throw new Exception("Sending confirmation email encountered errors. Please contact system administrator.");
            }
        }
